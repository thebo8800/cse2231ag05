...
public abstract class ListTest {
	...
	/**
	 * Invokes the appropriate {@code List} constructor for the implementation under
	...
	/**
	 * Constructs a {@code List<String>} with the entries in {@code args} and length
	 * of the left string equal to {@code leftLength}.
	 *
	 * @param list       the {@code List} to construct
	 * @param leftLength the length of the left string in the constructed
	 *                   {@code List}
	 * @param args       the entries for the list
	 * @updates list
	...
	/**
	 * Creates and returns a {@code List<String>} of the implementation under test
	...
	/**
	 * Creates and returns a {@code List<String>} of the reference implementation
	 * type with the given entries.
	 *
	 * @param leftLength the length of the left string in the constructed
	 *                   {@code List}
	...
	public final void testAddRightFrontLeftNonEmptyRightEmpty() {
		...
		List<String> list2 = this.createFromArgsRef(3, "yellow", "orange", "purple", "red");
		/*
		 * Call method under test
		 */
		list1.addRightFront("red");
	...
	public final void testAddRightFrontLeftNonEmptyRightNonEmpty() {
		...
		List<String> list2 = this.createFromArgsRef(2, "yellow", "orange", "green", "purple");
		/*
		 * Call method under test
		 */
		list1.addRightFront("green");
	...
	public final void testRemoveRightFrontLeftNonEmptyRightOne() {
		 ...
		 * Set up variables
		 */
		List<String> list1 = this.createFromArgsTest(3, "yellow", "orange", "purple", "red");
	...
	public final void testRemoveRightFrontLeftNonEmptyRightNonEmpty() {
		 ...
		 * Set up variables
		 */
		List<String> list1 = this.createFromArgsTest(2, "yellow", "orange", "green", "purple");
	...
	public final void testAdvanceLeftNonEmptyRightOne() {
		 ...
		 */
		List<String> list1 = this.createFromArgsTest(3, "yellow", "orange", "purple", "red");
		List<String> list2 = this.createFromArgsRef(4, "yellow", "orange", "purple", "red");
		/*
		 * Call method under test
		 */
		list1.advance();
	...
	public final void testAdvanceLeftNonEmptyRightNonEmpty() {
		 ...
		 */
		List<String> list1 = this.createFromArgsTest(2, "yellow", "orange", "green", "purple");
		List<String> list2 = this.createFromArgsRef(3, "yellow", "orange", "green", "purple");
		/*
		 * Call method under test
		 */
		list1.advance();
	...
	public final void testMoveToStartLeftNonEmptyRightNonEmpty() {
		 ...
		 */
		List<String> list1 = this.createFromArgsTest(2, "yellow", "orange", "green", "purple");
		List<String> list2 = this.createFromArgsRef(0, "yellow", "orange", "green", "purple");
		list1.moveToStart();
		/*
		 * Assert that values of variables match expectations
		 */
	...
	public final void testIteratorLeftAndRight() {
		 ...
		 * Set up variables
		 */
		List<String> list1 = this.createFromArgsTest(2, "purple", "red", "green", "blue", "yellow");
		List<String> list2 = this.createFromArgsRef(0);
		List<String> list3 = this.createFromArgsRef(2, "purple", "red", "green", "blue", "yellow");
		List<String> list4 = this.createFromArgsRef(0, "yellow", "blue", "green", "red", "purple");
		/*
		 * Call method under test
		 */
		for (String s : list1) {
	...
	public final void testMoveToFinishLeftNonEmptyRightNonEmpty() {
		 ...
		 */
		List<String> list1 = this.createFromArgsTest(2, "yellow", "orange", "green", "purple");
		List<String> list2 = this.createFromArgsRef(4, "yellow", "orange", "green", "purple");
		/*
		 * Call method under test
		 */
		list1.moveToFinish();
