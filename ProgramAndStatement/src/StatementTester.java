...
public final class StatementTester {
	...
	public static void main(String[] args) {
		 ...
		 * Get file name
		 */
		out.print("Enter a file name for a valid BL statement or " + "sequence of statements: ");
		String fileName = in.nextLine();
		/*
		 * Input statement(s) using the library implementation Statement1
		 */
		out.print("  Reading statement(s) using the library " + "implementation Statement1...");
		 ...
		 */
		out.print("  Reading statement(s) using the student " + "implementation Statement2...");
