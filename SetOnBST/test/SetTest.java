...
public abstract class SetTest {
	...
	/**
	 * Invokes the appropriate {@code Set} constructor for the implementation under
	...
	/**
	 * Creates and returns a {@code Set<String>} of the implementation under test
	 * type with the given entries.
	 *
	 * @param args the entries for the set
	...
	public final void testSizeMultiple() {
		 ...
		 */
		int num = 2 + 2;
		Set<String> test = this.createFromArgsTest("abc", "efg", "hij", "lmnop");
	...
	public final void testRemoveAnyLarge() {
		Set<String> test = this.createFromArgsTest("abc", "efg", "hij", "ape", "bonobo", "chimpanzee", "gorilla",
				"orangutan");
		Set<String> ref = this.createFromArgsRef("1", "2", "3", "4", "5", "6", "7");
